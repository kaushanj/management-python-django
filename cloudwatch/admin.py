...
from .models import Alarm, AlarmAction, AlermDimension, ARN, Dimension
...
class AlarmAdmin(admin.ModelAdmin):
    ...
    def response_post_save_change(self, request, obj):
        ...
        and calls the __create_cloudwatch_alarm method to create the CloudWatch alarm.
        ...
        self.__create_cloudwatch_alarm(
            obj, ok_actions, alarm_actions, dimensions)

        return super().response_post_save_change(request, obj)

    def __create_cloudwatch_alarm(self, obj, ok_actions, alarm_actions, dimensions):
        """
        Creates a CloudWatch alarm using the boto3 client.

        Args:
        - obj: The Alarm instance.
        - ok_actions: List of ARNs for OK actions.
        - alarm_actions: List of ARNs for alarm actions.
        - dimensions: List of dictionaries containing dimension information.
...
@admin.register(ARN)
class ARNAdmin(admin.ModelAdmin):
    """
    Custom admin configuration for the ARN model.
